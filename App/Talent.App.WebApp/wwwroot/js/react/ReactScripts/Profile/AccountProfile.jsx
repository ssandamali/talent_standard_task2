  ...
  saveProfile() {
    ...
    $.ajax({
      ...
      error: function (res, a, b) {
        TalentUtil.notification.show(
          "Error while saving Employer details",
          "error",
          null,
          null
        );
                    ...
                    {/*                    <FormItemWrapper
                                        ...
                                        >
                                            <VideoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveVideoUrl={'http://profile-service-talent.azurewebsites.net/profile/profile/updateTalentVideo'}
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='CV'
                                        ...
                                        >
                                            <CVUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveCVUrl={'http://profile-service-talent.azurewebsites.net/profile/profile/updateTalentCV'}
                                            />
                                        </FormItemWrapper> */}
                  </div>
                </form>
